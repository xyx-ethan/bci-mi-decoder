...
- Held-out test accuracy 0.93 (≈335/360 correct; Wilson 95 % CI ≈
  [0.900, 0.953]) on the BCI-ISLA 2026 development leaderboard
  (Codabench 15044, organised by Inria; 114 participants), tied for
  the highest displayed test score with two other participants;
  macro-average 5-fold selection-CV 0.9512 (or 0.9496 with a Subject
  3 6-seed robustness substitution).
